...
class Presentr {
    ...
    _options = {
        ...
        // Query selectors
        slides: 'header, section.level2',
        fragments: '.frag',  // section > ul > li
        ...
        shortcuts: {
            nextSlide: ['ArrowUp'],
            previousSlide: ['ArrowDown'],

            firstSlide: [],
            lastSlide: [],

            nextFragment: ['ArrowRight', 'PageDown'],
            previousFragment: ['ArrowLeft', 'PageUp']
        }
    };
